...
export default function ViewBranch() {
    ...
    useEffect(() => {
        if (branchCode) {
            axios.get(`http://localhost:2024/viewbranch/${branchCode}`)
                .then((response)=>{
                ...
                <div className='view-section'>
                    ...
                    <div className='branch-details'>
                        ...
                        <table>
                            ...
                            <tr>
                                <th>Alternate No : </th>
                                    <td>{branch.inchargerAlternateContactNo}</td>
                                <th>Whatsapp No : </th>
                        ...
                        <table>
                            ...
                            <tr>
                                <th>Alternate No : </th>
                                <td>{branch.contactPersonNameAlternateNo}</td>
                                <th>Whatsapp No : </th>
                                <td>{branch.contactPersonNameWhatsappNo}</td>
                            </tr>
                            <tr>
                                <th>Email-ID : </th>
                                <td>{branch.contactPersonNameEMailID}</td>
                            </tr>
                        </table>
